...
=== Exporting a VCard file(.vcf) from OneBook : `export`

Create a VCard file and export from OneBook to directory +
Format: `export [file directory]`

****
* Exports a VCard file to a valid directory.
* The created file must end with VCard extension(.vcf).
