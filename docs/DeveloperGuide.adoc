...
4.  Address Book deletes the person
+
Use case ends.
...
2.  Address Book list the person that corresponds to the name.
+
Use case ends.
...
2.  Address Book adds the person
...
2. Address Book displays list of usage instructions
+
Use case ends.
