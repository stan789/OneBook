...
public class BinSortCommand extends Command {

    public static final String COMMAND_WORD = "binsort";

    public static final String SORT_NAME = "name";

    public static final String SORT_EMAIL = "email";

    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Sorts bin by name or email.\n"
            + "Parameters: KEYWORD [MORE_KEYWORDS]...\n"
            + "Example for sort by name: " + COMMAND_WORD + " name\n"
            + "Example for sort by email: " + COMMAND_WORD + " email";

    public static final String MESSAGE_SUCCESS = "The bin has been sorted.";

    public static final String MESSAGE_NO_PERSON_TO_SORT = "There is no contacts to be sorted";

    public final String sortType;

    public BinSortCommand (String sortType) {
    ...
    public boolean equals(Object other) {
        return other == this // short circuit if same object
                || (other instanceof BinSortCommand // instanceof handles nulls
                && this.sortType.equals(((BinSortCommand) other).sortType)); // state check
    }
}
