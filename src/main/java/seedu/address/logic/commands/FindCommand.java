...
public class FindCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD + ": "
            ...
            + "MAIN_KEYWORD: [name] / [address] / [email] / [phone] / [organisation]\n"
            ...
            + "Example: " + COMMAND_WORD + " organisation " + "Apple Inc.";
    ...
    public static final String KEYWORD_ORGANISATION = "organisation";
