...
public class WebViewUtil {
    ...
    /**
     * If the {@code addressPanelHandle}'s {@code WebView} is loading, sleeps the thread till it is successfully loaded.
     */
    public static void waitUntilBrowserLoaded(AddressPanelHandle addressPanelHandle) {
        new GuiRobot().waitForEvent(addressPanelHandle::isLoaded);
    }
}
